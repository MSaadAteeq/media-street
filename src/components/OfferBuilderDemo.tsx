...
const OfferBuilderDemo = () => {
  ...
  const handleGenerateOffer = async () => {
    ...
    try {
      ...
      const isDeploymentIssue = errorMessage.includes('Load failed') || errorMessage.includes('FunctionsFetchError') || errorMessage.includes('Failed to send');
      toast({
        title: "Error",
        description: isDeploymentIssue ? "The AI feature is currently unavailable. Please try again later." : "Failed to generate offer. Please try again.",
        variant: "destructive"
      });
    } finally {
              ...
              <div className="space-y-4">
                ...
                {generatedOffer && <div className="space-y-6">
                    ...
                    <div className="relative aspect-video w-full overflow-hidden rounded-lg border-2">
                      ...
                      {offerImage ? <img src={offerImage} alt="Offer background" className="w-full h-full object-cover" style={{
                    objectPosition: 'center 30%'
                  }} /> : <div className="w-full h-full flex items-center justify-center" style={{
                    background: 'linear-gradient(135deg, rgb(147 51 234) 0%, rgb(126 58 242) 100%)'
                  }}>
                      ...
                      <div className="absolute inset-0 flex flex-col justify-between p-6">
                        ...
                        backgroundColor: brandColors.primary
                          ...
                          <div className="flex flex-col items-end gap-2">
                            ...
                            <div className="bg-white/90 backdrop-blur-sm px-2.5 py-1 rounded-full shadow-md">
                              <span className="text-xs font-semibold text-gray-900">.1 mi away</span>
                            </div>
                          </div>
                        </div>

                        {/* Bottom: Offer Text with semi-transparent background */}
                        <div className="space-y-2 bg-black/50 backdrop-blur-sm p-4 rounded-lg max-w-[90%]">
                      ...
                      {showCTA && <div className="absolute inset-0 bg-gradient-to-br from-slate-900/75 to-slate-800/70 backdrop-blur-sm flex items-center justify-center animate-fade-in">
                          <div className="text-center space-y-6 px-6 max-w-2xl">
                            ...
                            <p className="text-lg text-slate-200">Sign up now to customize and instantly activate this offer at stores</p>
                            <RequestInviteForm>
